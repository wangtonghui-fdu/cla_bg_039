...
int main()
{
  ...
  uint64 in_m = 0xfae849273928f89fLL; // Must be odd.
  uint64 in_b = 0x14736defb9330573LL; // Must be smaller than m.
  uint64 in_a = 0x0549372187237fefLL; // Must be smaller than m.
