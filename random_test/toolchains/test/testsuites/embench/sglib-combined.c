...
#define SGLIB___BIN_TREE_MAP_ON_ELEMENTS(type, tree, iteratedVariable, order, left, right, command)                     \
  {                                                                                                                     \
    ...
    {                                                                                                                   \
      ...
      {                                                                                                                 \
        _pathi_--;                                                                                                      \
        if ((order == 1 && _pass_[_pathi_] == 0) || (order == 2 && (_pass_[_pathi_] == 1 || _right_[_pathi_] == NULL))) \
        {                                                                                                               \
          iteratedVariable = _path_[_pathi_];                                                                           \
          {                                                                                                             \
            command;                                                                                                    \
...
#define SGLIB___RBTREE_FIX_INSERTION_DISCREPANCY(type, tree, leftt, rightt, bits, RED, BLACK)                                                       \
  {                                                                                                                                                 \
    ...
    {                                                                                                                                               \
      ...
      {                                                                                                                                             \
        if ((tl->leftt != NULL && SGLIB___GET_VALUE(tl->leftt->bits) == RED) || (tl->rightt != NULL && SGLIB___GET_VALUE(tl->rightt->bits) == RED)) \
        {                                                                                                                                           \
...
int main()
{
  ...
  res = (15050 == cnt) && check_heap_beebs((void *)heap) && (0 == memcmp(array2, array_exp, 100 * sizeof(array[0])));
