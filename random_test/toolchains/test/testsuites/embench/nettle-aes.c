...
#define SUBBYTE(x, box) ((uint32_t)(box)[B0(x)] | ((uint32_t)(box)[B1(x)] << 8) | ((uint32_t)(box)[B2(x)] << 16) | ((uint32_t)(box)[B3(x)] << 24))
...
#define AES_FINAL_ROUND(T, w0, w1, w2, w3, k) \
  (((uint32_t)T->sbox[B0(w0)] | ((uint32_t)T->sbox[B1(w1)] << 8) | ((uint32_t)T->sbox[B2(w2)] << 16) | ((uint32_t)T->sbox[B3(w3)] << 24)) ^ (k))
...
void _aes_set_key(unsigned nr, unsigned nk,
