...
#define D 2
  ...
  int In[340] =
	...
	int Out[340] = {
      A, C, B, C, A, C, B, C, A, C, A, C, B, C, A, C, 
      C, A, C, B, C, A, C, A, C, A, C, A, C, A, C, A,
      C, A, C, A, C, A, C, A, C, A, C, A, C, A, C, A,
      C, A, C, A, C, A, C, A, C, A, C, A, C, A, C, A, 
      C, A, C, A, C, A, C, A, C, A, C, A, B, A, C, A,
      C, A, C, B, C, A, B, A, C, A, C, A, C, A, C, A,
      C, A, C, A, C, A, C, A, C, A, C, B, C, A, C, A,
      C, A, B, A, C, A, C, A, C, A, C, A, C, A, C, A,
      C, A, C, A, C, A, C, A, C, A, C, A, C, A, C, A,
      A, C, A, C, A, C, A, C, A, C, A, B, A, C, A, C, 
      D, C, A, B, C, D, D, D, A, D, D, C, C, C, A, D,
      0, 0, 1, 1, 2, 1, 0, 1, 0, 0, 1, 1, 2, 1, 0, 1, 
      D, C, A, B, C, D, A, D, A, D, D, C, C, C, A, B,
      0, 0, 1, 1, 2, 1, 0, 1, 0, 0, 1, 1, 2, 1, 0, 1, 
      3, 3, 1, 1, 2, 1, 0, 1, 3, 3, 1, 1, 2, 1, 0, 1
