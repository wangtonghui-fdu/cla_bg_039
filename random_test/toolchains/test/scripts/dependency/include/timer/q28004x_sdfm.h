#ifndef Q28004X_SDFM_H
#define Q28004X_SDFM_H
...
struct SDIFLG_BITS
{                        // bits description
    Uint32 IFH1     : 1; // 0 High-level Interrupt flag for Ch1
    Uint32 IFL1     : 1; // 1 Low-level Interrupt flag for Ch1
    Uint32 IFH2     : 1; // 2 High-level Interrupt flag for Ch2
    Uint32 IFL2     : 1; // 3 Low-level Interrupt flag for Ch2
    Uint32 IFH3     : 1; // 4 High-level Interrupt flag for Ch3
    Uint32 IFL3     : 1; // 5 Low-level Interrupt flag for Ch3
    Uint32 IFH4     : 1; // 6 High-level Interrupt flag for Ch4
    Uint32 IFL4     : 1; // 7 Low-level Interrupt flag for Ch4
    Uint32 MF1      : 1; // 8 Modulator Failure for Filter 1
    Uint32 MF2      : 1; // 9 Modulator Failure for Filter 2
    Uint32 MF3      : 1; // 10 Modulator Failure for Filter 3
    Uint32 MF4      : 1; // 11 Modulator Failure for Filter 4
    Uint32 AF1      : 1; // 12 Acknowledge flag for Filter 1
    Uint32 AF2      : 1; // 13 Acknowledge flag for Filter 2
    Uint32 AF3      : 1; // 14 Acknowledge flag for Filter 3
    Uint32 AF4      : 1; // 15 Acknowledge flag for Filter 4
    Uint32 SDFFOVF1 : 1; // 16 FIFO Overflow Flag for Ch1.
    Uint32 SDFFOVF2 : 1; // 17 FIFO Overflow Flag for Ch2
    Uint32 SDFFOVF3 : 1; // 18 FIFO Overflow Flag for Ch3
    Uint32 SDFFOVF4 : 1; // 19 FIFO Overflow Flag for Ch4
    Uint32 SDFFINT1 : 1; // 20 SDFIFO interrupt for Ch1
    Uint32 SDFFINT2 : 1; // 21 SDFIFO interrupt for Ch2
    Uint32 SDFFINT3 : 1; // 22 SDFIFO interrupt for Ch3
    Uint32 SDFFINT4 : 1; // 23 SDFIFO interrupt for Ch4
    Uint32 rsvd1    : 7; // 30:24 Reserved
    Uint32 MIF      : 1; // 31 Master Interrupt Flag
};
...
{                        // bits description
    ...
    Uint32 AF3      : 1; // 14 Acknowledge flag for Filter 3
    Uint32 AF4      : 1; // 15 Acknowledge flag for Filter 4
    Uint32 SDFFOVF1 : 1; // 16 SDFIFO overflow clear Ch1
    Uint32 SDFFOVF2 : 1; // 17 SDFIFO overflow clear Ch2
    Uint32 SDFFOVF3 : 1; // 18 SDFIFO overflow clear Ch3
    Uint32 SDFFOVF4 : 1; // 19 SDFIFO overflow clear Ch4
    Uint32 SDFFINT1 : 1; // 20 SDFIFO Interrupt flag-clear bit for Ch1
    Uint32 SDFFINT2 : 1; // 21 SDFIFO Interrupt flag-clear bit for Ch2
    Uint32 SDFFINT3 : 1; // 22 SDFIFO Interrupt flag-clear bit for Ch3
    Uint32 SDFFINT4 : 1; // 23 SDFIFO Interrupt flag-clear bit for Ch4
    Uint32 rsvd1    : 7; // 30:24 Reserved
    Uint32 MIF      : 1; // 31 Master Interrupt Flag
};
...
struct SDDATA1_BITS
{                         // bits description
    Uint32 DATA16   : 16; // 15:0 Lo-order 16b in 32b mode
    Uint32 DATA32HI : 16; // 31:16 Hi-order 16b in 32b mode, 16-bit Data in 16b mode
};
