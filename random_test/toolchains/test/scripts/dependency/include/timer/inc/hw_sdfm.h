...
#define SDFM_O_SDCMPH1      0x26U   // High-level Threshold Register for Ch1
#define SDFM_O_SDCMPL1      0x28U   // Low-level Threshold Register for Ch1
...
#define SDFM_O_SDCMPHZ1     0x38U   // High-level (Z) Threshold Register for Ch1
...
#define SDFM_O_SDCMPH2      0x46U   // High-level Threshold Register for Ch2
#define SDFM_O_SDCMPL2      0x48U   // Low-level Threshold Register for Ch2
...
#define SDFM_O_SDCMPHZ2     0x58U   // High-level (Z) Threshold Register for Ch2
...
#define SDFM_O_SDCMPH3      0x66U   // High-level Threshold Register for Ch3
#define SDFM_O_SDCMPL3      0x68U   // Low-level Threshold Register for Ch3
...
#define SDFM_O_SDCMPHZ3     0x78U   // High-level (Z) Threshold Register for Ch3
...
#define SDFM_O_SDCMPH4      0x86U   // High-level Threshold Register for Ch4
#define SDFM_O_SDCMPL4      0x88U   // Low-level Threshold Register for Ch4
...
#define SDFM_O_SDCMPHZ4     0x98U   // High-level (Z) Threshold Register for Ch4
