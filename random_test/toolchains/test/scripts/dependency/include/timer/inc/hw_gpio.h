...
#define GPIO_O_GPAQSEL1   0x4U     // GPIO A Qualification Type (GPIO0 to GPIO15)
#define GPIO_O_GPAQSEL2   0x8U     // GPIO A Qualification Type (GPIO16 to GPIO31)
#define GPIO_O_GPAMUX1    0xCU     // GPIO A Peripheral Mux (GPIO0 to GPIO15)
#define GPIO_O_GPAMUX2    0x10U    // GPIO A Peripheral Mux (GPIO16 to GPIO31)
#define GPIO_O_GPADIR     0x14U    // GPIO A Direction (GPIO0 to GPIO31)
#define GPIO_O_GPAPUD     0x18U    // GPIO A Pull-Up Disable (GPIO0 to GPIO31)
#define GPIO_O_GPAINV     0x1CU    // GPIO A Input Inversion (GPIO0 to GPIO31)
#define GPIO_O_GPAODR     0x20U    // GPIO A Open Drain Output Mode (GPIO0 to GPIO31)
#define GPIO_O_GPAAMSEL   0x24U    // GPIO A Analog Mode Select (GPIO0 to GPIO31)
#define GPIO_O_GPAGMUX1   0x28U    // GPIO A Peripheral Group Mux (GPIO0 to GPIO15)
#define GPIO_O_GPAGMUX2   0x2CU    // GPIO A Peripheral Group Mux (GPIO16 to GPIO31)
#define GPIO_O_GPALOCK    0x30U    // GPIO A Lock Register (GPIO0 to GPIO31)
#define GPIO_O_GPACR      0x34U    // GPIO A Lock Commit Register (GPIO0 to GPIO31)

#define GPIO_O_GPBCTRL    0x50U    // GPIO B Qualification Sampling Period (GPIO32 to GPIO63)
#define GPIO_O_GPBQSEL1   0x54U    // GPIO B Qualification Type (GPIO32 to GPIO47)
#define GPIO_O_GPBQSEL2   0x58U    // GPIO B Qualification Type (GPIO48 to GPIO63)
#define GPIO_O_GPBMUX1    0x5CU    // GPIO B Peripheral Mux (GPIO32 to GPIO47)
#define GPIO_O_GPBMUX2    0x60U    // GPIO B Peripheral Mux (GPIO48 to GPIO63)
#define GPIO_O_GPBDIR     0x64U    // GPIO B Direction (GPIO32 to GPIO63)
#define GPIO_O_GPBPUD     0x68U    // GPIO B Pull-Up Disable (GPIO32 to GPIO63)
#define GPIO_O_GPBINV     0x70U    // GPIO B Input Inversion (GPIO32 to GPIO63)
#define GPIO_O_GPBODR     0x74U    // GPIO B Open Drain Output Mode (GPIO32 to GPIO63)
#define GPIO_O_GPBGMUX1   0x78U    // GPIO B Peripheral Group Mux (GPIO32 to GPIO47)
#define GPIO_O_GPBGMUX2   0x7CU    // GPIO B Peripheral Group Mux (GPIO48 to GPIO63)
#define GPIO_O_GPBLOCK    0x80U    // GPIO B Lock Register (GPIO32 to GPIO63)
#define GPIO_O_GPBCR      0x84U    // GPIO B Lock Commit Register (GPIO32 to GPIO63)

#define GPIO_O_GPHCTRL    0xA0U   // GPIO H Qualification Sampling Period (GPIO224 to GPIO255)
#define GPIO_O_GPHQSEL1   0xA4U   // GPIO H Qualification Type (GPIO224 to GPIO239)
#define GPIO_O_GPHQSEL2   0xA8U   // GPIO H Qualification Type (GPIO240 to GPIO255)
#define GPIO_O_GPHPUD     0xACU   // GPIO H Pull-Up Disable (GPIO224 to GPIO255)
#define GPIO_O_GPHINV     0xB0U   // GPIO H Input Inversion (GPIO224 to GPIO255)
#define GPIO_O_GPHAMSEL   0xB4U   // GPIO H Analog Mode Select (GPIO224 to GPIO255)
#define GPIO_O_GPHLOCK    0xB8U   // GPIO H Lock Register (GPIO224 to GPIO255)
#define GPIO_O_GPHCR      0xBCU   // GPIO H Lock Commit Register (GPIO224 to GPIO255)

#define GPIO_O_GPADAT      0x0U    // GPIO A Data Register (GPIO0 to GPIO31)
#define GPIO_O_GPASET      0x4U    // GPIO A Output Set (GPIO0 to GPIO31)
#define GPIO_O_GPACLEAR    0x8U    // GPIO A Output Clear (GPIO0 to GPIO31)
#define GPIO_O_GPATOGGLE   0xCU    // GPIO A Output Toggle (GPIO0 to GPIO31)
#define GPIO_O_GPBDAT      0x10U   // GPIO B Data Register (GPIO32 to GPIO64)
#define GPIO_O_GPBSET      0x14U   // GPIO B Output Set (GPIO32 to GPIO64)
#define GPIO_O_GPBCLEAR    0x18U   // GPIO B Output Clear (GPIO32 to GPIO64)
#define GPIO_O_GPBTOGGLE   0x1CU   // GPIO B Output Toggle (GPIO32 to GPIO64)
#define GPIO_O_GPHDAT      0x70U   // GPIO H Data Register (GPIO0 to GPIO255)
...
#define GPIO_GPHCTRL_QUALPRD0_M \
    0xFFU // Qualification sampling period for GPIO224 to
          // GPIO231
#define GPIO_GPHCTRL_QUALPRD1_S 8U
#define GPIO_GPHCTRL_QUALPRD1_M \
    0xFF00U // Qualification sampling period for GPIO232 to
            // GPIO239
#define GPIO_GPHCTRL_QUALPRD2_S 16U
#define GPIO_GPHCTRL_QUALPRD2_M \
    0xFF0000U // Qualification sampling period for GPIO240 to
              // GPIO247
...
#define GPIO_GPHQSEL1_GPIO224_M \
    0x3U // Select input qualification type for this GPIO
         // Pin
#define GPIO_GPHQSEL1_GPIO225_S 2U
#define GPIO_GPHQSEL1_GPIO225_M \
    0xCU // Select input qualification type for this GPIO
         // Pin
#define GPIO_GPHQSEL1_GPIO226_S 4U
#define GPIO_GPHQSEL1_GPIO226_M \
    0x30U // Select input qualification type for this GPIO
          // Pin
#define GPIO_GPHQSEL1_GPIO227_S 6U
#define GPIO_GPHQSEL1_GPIO227_M \
    0xC0U // Select input qualification type for this GPIO
          // Pin
#define GPIO_GPHQSEL1_GPIO228_S 8U
#define GPIO_GPHQSEL1_GPIO228_M \
    0x300U // Select input qualification type for this GPIO
           // Pin
#define GPIO_GPHQSEL1_GPIO229_S 10U
#define GPIO_GPHQSEL1_GPIO229_M \
    0xC00U // Select input qualification type for this GPIO
           // Pin
#define GPIO_GPHQSEL1_GPIO230_S 12U
#define GPIO_GPHQSEL1_GPIO230_M \
    0x3000U // Select input qualification type for this GPIO
            // Pin
#define GPIO_GPHQSEL1_GPIO231_S 14U
#define GPIO_GPHQSEL1_GPIO231_M \
    0xC000U // Select input qualification type for this GPIO
            // Pin
#define GPIO_GPHQSEL1_GPIO232_S 16U
#define GPIO_GPHQSEL1_GPIO232_M \
    0x30000U // Select input qualification type for this GPIO
             // Pin
#define GPIO_GPHQSEL1_GPIO233_S 18U
#define GPIO_GPHQSEL1_GPIO233_M \
    0xC0000U // Select input qualification type for this GPIO
             // Pin
#define GPIO_GPHQSEL1_GPIO234_S 20U
#define GPIO_GPHQSEL1_GPIO234_M \
    0x300000U // Select input qualification type for this GPIO
              // Pin
#define GPIO_GPHQSEL1_GPIO235_S 22U
#define GPIO_GPHQSEL1_GPIO235_M \
    0xC00000U // Select input qualification type for this GPIO
              // Pin
#define GPIO_GPHQSEL1_GPIO236_S 24U
#define GPIO_GPHQSEL1_GPIO236_M \
    0x3000000U // Select input qualification type for this GPIO
               // Pin
#define GPIO_GPHQSEL1_GPIO237_S 26U
#define GPIO_GPHQSEL1_GPIO237_M \
    0xC000000U // Select input qualification type for this GPIO
               // Pin
#define GPIO_GPHQSEL1_GPIO238_S 28U
#define GPIO_GPHQSEL1_GPIO238_M \
    0x30000000U // Select input qualification type for this GPIO
                // Pin
#define GPIO_GPHQSEL1_GPIO239_S 30U
#define GPIO_GPHQSEL1_GPIO239_M \
    0xC0000000U // Select input qualification type for this GPIO
                // Pin
