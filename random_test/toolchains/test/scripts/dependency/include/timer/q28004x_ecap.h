#ifndef Q28004X_ECAP_H
#define Q28004X_ECAP_H
...
struct ECAP_REGS
{
    Uint32 TSCTR;            // Time-Stamp Counter offset:0x00
    Uint32 CTRPHS;           // Counter Phase Offset Value Register offset:0x04
    Uint32 CAP1;             // Capture 1 Register offset:0x08
    Uint32 CAP2;             // Capture 2 Register offset:0x0C
    Uint32 CAP3;             // Capture 3 Register offset:0x10
    Uint32 CAP4;             // Capture 4 Register offset:0x14
    Uint32 rsvd1[3];         // Reserved offset:0x18~0x20
