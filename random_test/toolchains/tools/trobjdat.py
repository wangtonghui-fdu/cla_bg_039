...
for i in range(64,32768):
    ...
    addr =  '{0:0>4}'.format(hex(i).replace("0x",''))
    #i#fb_d.write(addr + '\n')
    fb_d.write("32'h001" + addr + '0,\t' + "128'h" + insn0.decode() + insn1.decode() + insn2.decode() + insn3.decode())
...
if(len(insnPack) == 8):
    ...
    insn3 = '80000000'
    addr =  '{0:0>4}'.format(hex(i).replace("0x",''))
    fb_d.write("32'h001" + addr + '0,\t' + "128'h" + insn0.decode() + insn3 + '_' + insn3 + '_' + insn3 + '\n')
    ...
    insn3 = '80000000'
    addr =  '{0:0>4}'.format(hex(i).replace("0x",''))
    fb_d.write("32'h001" + addr + '0,\t' + "128'h" + insn0.decode() + insn1.decode() + insn3 + '_' + insn3 + '\n')
    ...
    insn3 = '80000000'
    addr =  '{0:0>4}'.format(hex(i).replace("0x",''))
    fb_d.write("32'h001" + addr + '0,\t' + "128'h" + insn0.decode() + insn1.decode() + insn2.decode() + insn3 + '\n')
elif(len(insnPack) != 0):
