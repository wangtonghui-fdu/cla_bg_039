...
datFileIns = sourceFile[:-4]+ "_I.dat"
datFileData = sourceFile[:-4] + "_D.dat"
...
fb_data = open(datFileData,'w')
fb_ins = open(datFileIns,'w')
...
#        continue
    ...
    fb_data.write(insn7.decode() + insn6.decode() + "\n")
...
#        continue
    ...
    fb_ins.write(insn6.decode() + insn7.decode() + "\n")
    fb_ins.write(insn4.decode() + insn5.decode() + "\n")
    fb_ins.write(insn2.decode() + insn3.decode() + "\n")
    fb_ins.write(insn0.decode() + insn1.decode() + "\n")

insnPack = binascii.b2a_hex(insnPack)
if(len(insnPack) == 8):
    insn0 = insnPack[0:8]
    insn0 = insn0[6:8] + insn0[4:6] + insn0[2:4] + insn0[0:2]
    fb_ins.write('80000000' + '80000000' + "\n")
    fb_ins.write('80000000' + '80000000' + "\n")
    fb_ins.write('80000000' + '80000000' + "\n")
    fb_ins.write(insn0.decode() + '80000000' + "\n")
    ...
    fb_ins.write('80000000' + '80000000' + "\n")
    fb_ins.write('80000000' + '80000000' + "\n")
    fb_ins.write(insn2.decode() + '80000000' + "\n")
    fb_ins.write(insn0.decode() + insn1.decode() + "\n")
    ...
    insn4 = insn4[6:8] + insn4[4:6] + insn4[2:4] + insn4[0:2]
    fb_ins.write('80000000' + '80000000' + "\n")
    fb_ins.write(insn4.decode() + '80000000' + "\n")
    fb_ins.write(insn2.decode() + insn3.decode() + "\n")
    fb_ins.write(insn0.decode() + insn1.decode() + "\n")
    ...
    insn5 = insn5[6:8] + insn5[4:6] + insn5[2:4] + insn5[0:2]
    insn6 = insn6[6:8] + insn6[4:6] + insn6[2:4] + insn6[0:2]
    fb_ins.write(insn6.decode() + '80000000' + "\n")
    fb_ins.write(insn4.decode() + insn5.decode() + "\n")
    fb_ins.write(insn2.decode() + insn3.decode() + "\n")
    fb_ins.write(insn0.decode() + insn1.decode() + "\n")
